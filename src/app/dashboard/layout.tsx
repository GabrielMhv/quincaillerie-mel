...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen w-full bg-muted/40">
      <Suspense
        fallback={<div className="w-60 hidden md:block bg-card border-r" />}
      >
        <DashboardSidebar />
      </Suspense>
      <div className="flex flex-col flex-1 w-full overflow-hidden bg-linear-to-b from-primary/5 to-background">
