      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
          <h1 className="text-5xl font-black tracking-tighter leading-tight">
             Réseau de <span className="text-gradient leading-relaxed">Boutiques</span>
          </h1>
      ...
      <section className="rounded-[4rem] border border-border/50 bg-card/80 backdrop-blur-xl shadow-premium overflow-hidden">
        <div className="p-10 border-b border-border/50 bg-muted/30 flex justify-between items-center">
           ...
           <div className="px-5 py-2 rounded-2xl bg-primary/10 border border-primary/20 flex items-center gap-2">
              ...
              <span className="text-xs font-black tracking-widest text-primary">Gestion Centralisée</span>
           </div>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border/20">
              {stores?.map((store: Store) => (
                <tr key={store.id} className="group hover:bg-primary/[0.02] transition-all h-28">
                  <td className="px-10">
                    <div className="flex items-center gap-5">
                      <div className="h-14 w-14 rounded-[1.5rem] bg-secondary/50 flex items-center justify-center text-primary group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-500 shadow-sm border border-border/50">
                ...
                <tr className="h-80">
                  <td colSpan={3} className="text-center">
                    <div className="flex flex-col items-center justify-center space-y-5 opacity-20">
                       ...
                       <p className="text-lg font-black tracking-widest leading-none">Aucun point de vente répertorié</p>
                    </div>
                  </td>
                </tr>
              )}
