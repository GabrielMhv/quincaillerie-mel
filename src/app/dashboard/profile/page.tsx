...
export default async function ProfilePage() {
  ...
  // Fetch user profile with boutique info from 'profiles'
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "completed":
        return (
          <Badge className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 rounded-full px-3 py-0.5 text-[10px] font-black tracking-widest">
            Terminée
          </Badge>
        );
      case "pending":
        return (
          <Badge
            variant="outline"
            className="text-amber-600 border-amber-600/20 bg-amber-500/10 rounded-full px-3 py-0.5 text-[10px] font-black tracking-widest"
          >
            En attente
          </Badge>
        );
      case "cancelled":
        return (
          <Badge
            variant="destructive"
            className="rounded-full px-3 py-0.5 text-[10px] font-black tracking-widest"
          >
            Annulée
          </Badge>
        );
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000">
      ...
      <section className="flex flex-row items-center justify-between gap-6 px-10 py-12 rounded-[3.5rem] bg-indigo-500/5 border border-indigo-500/10 relative overflow-hidden group shadow-premium">
        ...
        <div className="space-y-3 relative z-10 font-black tracking-tighter leading-none mb-1">
          ...
          <h1 className="text-6xl font-black tracking-tighter leading-none mb-1">
            Mon <span className="text-indigo-500 italic">Profil</span>
          </h1>
          ...
          <div className="rounded-[3.5rem] border border-border/50 bg-card/80 backdrop-blur-xl shadow-premium p-10 relative overflow-hidden group">
            ...
            <div className="flex flex-col items-center text-center space-y-6 relative z-10">
              <div className="relative">
                <div className="h-32 w-32 rounded-[2.5rem] bg-linear-to-br from-primary/20 to-secondary/20 p-1 flex items-center justify-center border border-primary/20 shadow-lg">
              ...
              <div className="space-y-1">
                ...
                <Badge
                  variant="outline"
                  className="px-4 py-1 rounded-full border-primary/20 bg-primary/5 text-primary text-[10px] font-black tracking-widest italic"
                >
                  {profile?.role === "admin"
                    ? "Administrateur"
                    ...
                    <tr className="flex-1 min-h-100">
                      <td colSpan={4} className="h-80 text-center">
                        <div className="flex flex-col items-center justify-center space-y-5 opacity-20">
                          ...
                          <p className="text-lg font-black tracking-widest text-center italic">
