        ...
        <div className="container mx-auto px-4 md:px-6 pt-12 md:pt-20 lg:pt-32 space-y-20 md:space-y-32 relative z-10">
          ...
          <div className="max-w-5xl mx-auto text-center space-y-6 md:space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-5 py-1.5 md:py-2 rounded-full bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 backdrop-blur-xl text-primary text-[9px] md:text-[11px] font-black tracking-widest leading-none shadow-sm">
              <Sparkles className="h-3.5 w-3.5 md:h-4 md:w-4" /> Rejoindre
              l&apos;excellence
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-9xl font-black tracking-tighter leading-none md:leading-[0.9] text-slate-900 dark:text-white">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-12 gap-12 lg:gap-16 items-start relative px-4 lg:px-0">
            ...
            <div className="lg:col-span-4 space-y-6 md:space-y-8 lg:sticky lg:top-32">
              <div className="space-y-3 md:space-y-4 mb-8 md:mb-12 text-center lg:text-left">
                <h2 className="text-[9px] md:text-[10px] font-black tracking-widest text-primary opacity-60">
              ...
              {contactInfo.map((item, i) => (
                <div
                  key={i}
                  className={cn(
                    "group relative p-6 md:p-8 rounded-3xl md:rounded-[2.5rem] border border-white/20 dark:border-white/5 bg-white/30 dark:bg-white/5 backdrop-blur-3xl hover:bg-white/50 dark:hover:bg-white/10 transition-all duration-700 hover:shadow-2xl hover:shadow-primary/5",
                ...
                >
                  <div className="flex items-center gap-4 md:gap-6 relative z-10">
                    ...
                    <div>
                      <h3 className="text-[9px] md:text-[10px] font-black tracking-widest text-muted-foreground mb-1 md:mb-2">
                        {item.title}
                      </h3>
                      <p className="text-lg md:text-xl font-black tracking-tighter leading-none mb-1 text-slate-800 dark:text-white">
                        {item.value}
                      </p>
                      <p className="text-[10px] md:text-[12px] font-bold text-muted-foreground opacity-60 italic">
                        {item.description}
                      </p>
                    </div>
                  </div>
              ...
              <div className="pt-6 md:pt-8 grid grid-cols-2 gap-4">
                <div className="p-4 md:p-6 rounded-3xl md:rounded-4xl bg-indigo-500/5 border border-indigo-500/10 flex flex-col items-center text-center gap-2 md:gap-3">
                  <ShieldCheck className="h-5 w-5 md:h-6 md:w-6 text-indigo-400" />
                  <span className="text-[8px] md:text-[9px] font-black tracking-widest opacity-40">
                    Données sécurisées
                  </span>
                </div>
                <div className="p-4 md:p-6 rounded-3xl md:rounded-4xl bg-emerald-500/5 border border-emerald-500/10 flex flex-col items-center text-center gap-2 md:gap-3">
            ...
            <div className="lg:col-span-8 animate-in fade-in slide-in-from-right-12 duration-1000 delay-300 w-full mt-8 lg:mt-0">
              <div className="relative group p-1 md:p-1.5 rounded-4xl md:rounded-[4.5rem] bg-linear-to-br from-white/20 to-transparent dark:from-white/10 border border-white/30 dark:border-white/10 shadow-3xl">
                <div className="p-6 sm:p-10 lg:p-20 bg-white/60 dark:bg-slate-900/60 backdrop-blur-3xl rounded-3xl md:rounded-[4rem] relative overflow-hidden ring-1 ring-white/50 dark:ring-white/5">
                    ...
                    <div className="text-center space-y-12 animate-in zoom-in-95 duration-700 max-w-md mx-auto py-12 relative z-10">
                      ...
                      <div className="space-y-6">
                        ...
                        <p className="text-xl text-muted-foreground font-medium leading-relaxed">
                          Votre message a traversé le réseau avec succès.
                          L&apos;un de nos managers reviendra vers vous
                          incessamment.
                        </p>
                      </div>
                      <Button
                    ...
                    >
                      <div className="grid gap-6 md:gap-10 sm:grid-cols-2">
                        <div className="group/field space-y-2 md:space-y-4">
                          <Label
                            htmlFor="first_name"
                            className="text-[10px] md:text-[11px] font-black tracking-[0.2em] text-primary ml-1 md:ml-2 flex items-center gap-2"
                          >
                            01{" "}
                            <span className="h-px w-6 md:w-8 bg-primary/30" />{" "}
                            Prénom
                          </Label>
                          <Input
                            name="first_name"
                            ...
                            className="h-14 md:h-16 rounded-[1.25rem] md:rounded-3xl bg-white dark:bg-slate-800/50 border-white/40 dark:border-white/5 focus-visible:ring-primary focus-visible:bg-white dark:focus-visible:bg-slate-800 transition-all px-6 md:px-8 text-base md:text-lg font-bold tracking-tight shadow-sm"
                          />
                        </div>
                        <div className="group/field space-y-2 md:space-y-4">
                          <Label
                      ...
                      <div className="group/field space-y-2 md:space-y-4">
                        <Label
                          ...
                          className="text-[10px] md:text-[11px] font-black tracking-[0.2em] text-primary ml-1 md:ml-2 flex items-center gap-2"
                        >
                          03 <span className="h-px w-6 md:w-8 bg-primary/30" />{" "}
                          Email professionnel
                        </Label>
                        <Input
                          name="email"
                          ...
                          type="email"
                          required
                          placeholder="direction@projet-btp.tg"
                          className="h-14 md:h-16 rounded-[1.25rem] md:rounded-3xl bg-white dark:bg-slate-800/50 border-white/40 dark:border-white/5 focus-visible:ring-primary focus-visible:bg-white dark:focus-visible:bg-slate-800 transition-all px-6 md:px-8 text-base md:text-lg font-bold tracking-tight shadow-sm"
                        />
                      </div>
                      ...
                      <div className="group/field space-y-2 md:space-y-4">
                        <Label
                          ...
                          className="text-[10px] md:text-[11px] font-black tracking-[0.2em] text-primary ml-1 md:ml-2 flex items-center gap-2"
                        >
                          04 <span className="h-px w-6 md:w-8 bg-primary/30" />{" "}
                        ...
                        <Input
                          ...
                          id="subject"
                          required
                          placeholder="Ex: Devis Gros Œuvre / Projet Ségbé"
                          className="h-14 md:h-16 rounded-[1.25rem] md:rounded-3xl bg-white dark:bg-slate-800/50 border-white/40 dark:border-white/5 focus-visible:ring-primary focus-visible:bg-white dark:focus-visible:bg-slate-800 transition-all px-6 md:px-8 text-base md:text-lg font-bold tracking-tight shadow-sm"
                        />
                      </div>
                      ...
                      <div className="group/field space-y-2 md:space-y-4">
                        <Label
                          ...
                          className="text-[10px] md:text-[11px] font-black tracking-[0.2em] text-primary ml-1 md:ml-2 flex items-center gap-2"
                        >
                          05 <span className="h-px w-6 md:w-8 bg-primary/30" />{" "}
                          Votre vision détaillée
                        </Label>
                        <Textarea
                          name="message"
                          id="message"
                          ...
                          className="bg-white dark:bg-slate-800/50 border-white/40 dark:border-white/5 min-h-40 md:min-h-55 rounded-3xl md:rounded-[2.5rem] p-6 md:p-8 focus-visible:ring-primary focus-visible:bg-white dark:focus-visible:bg-slate-800 transition-all text-base md:text-lg font-bold tracking-tight shadow-sm resize-none"
                        />
                      </div>
                      ...
                      <div className="pt-4 md:pt-6">
                        <Button
                          ...
                          disabled={loading}
                          size="lg"
                          className="w-full h-16 md:h-20 text-base md:text-xl font-black tracking-tighter gap-3 md:gap-4 rounded-3xl md:rounded-4xl shadow-2xl shadow-primary/30 hover:shadow-primary/50 transition-all hover:-translate-y-2 active:scale-[0.98] group bg-primary relative overflow-hidden"
                        >
                          ...
                          {!loading && (
                            <Send className="h-5 w-5 md:h-6 md:w-6 transition-transform group-hover:translate-x-3 group-hover:-translate-y-2" />
                          )}
                        </Button>
                      </div>
          ...
          <div className="pt-20 md:pt-32 px-4 lg:px-0">
            <div className="relative rounded-[2.5rem] md:rounded-[6rem] p-1 md:p-2 bg-linear-to-br from-primary/20 to-transparent border border-white/20 shadow-2xl overflow-hidden group">
              ...
              <div className="relative z-20 w-full h-112.5 md:h-150 flex items-center justify-center overflow-hidden rounded-4xl md:rounded-[5.5rem] bg-linear-to-br from-slate-900 via-slate-800 to-slate-950 border border-white/10">
                <div className="absolute inset-0 overflow-hidden">
                  <div className="absolute top-1/4 left-1/4 w-50 md:w-75 h-50 md:h-75 bg-primary/20 rounded-full blur-[60px] md:blur-[100px] animate-pulse" />
                  <div className="absolute bottom-1/4 right-1/4 w-62.5 md:w-100 h-62.5 md:h-100 bg-emerald-400/10 rounded-full blur-[60px] md:blur-[100px] animate-pulse delay-700" />
                </div>
                ...
                <div className="text-center space-y-6 md:space-y-10 max-w-2xl px-6 md:px-12 relative z-30">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-white/50 font-medium leading-relaxed">
                      ...
                      Venez découvrir notre showroom et bénéficier d&apos;un
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 mt-4 md:mt-0 w-full sm:w-auto">
                    ...
                    <Button
                      variant="outline"
                      className="w-full sm:w-auto rounded-full px-8 md:px-10 h-14 md:h-16 border-white/20 text-white hover:bg-white/10 font-bold tracking-tight text-base md:text-lg backdrop-blur-md"
                    >
                      Nos horaires
                    </Button>
                  </div>
                ...
                <div className="absolute top-12 left-12 glass p-6 rounded-3xl border-white/10 text-white/40 space-y-2 hidden xl:block">
                  ...
                  <div className="text-xs font-mono">
                    Boutique Ségbé: active
                  </div>
                  <div className="text-xs font-mono">
                    Boutique Sanguera: active
                  </div>
                </div>
              </div>
            </div>
