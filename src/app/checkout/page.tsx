    ...
    <PublicLayout>
      <div className="relative min-h-screen py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="mx-auto max-w-3xl glass-card rounded-[2rem] md:rounded-[3.5rem] overflow-hidden p-1.5 md:p-2 shadow-premium animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
