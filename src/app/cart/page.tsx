          ...
          <div className="container mx-auto px-6 text-center space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                Votre panier <br />{" "}
                <span className="text-gradient">est vide.</span>
              </h1>
              <p className="text-xl text-muted-foreground font-medium max-w-lg mx-auto leading-relaxed">
                Prêt à lancer votre prochain projet ? Explorez le catalogue de
                La Championne pour trouver le matériel d&apos;exception.
              </p>
            </div>
  ...
  return (
    <PublicLayout>
      <div className="relative min-h-screen pb-32 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-150 h-150 bg-primary/5 rounded-full blur-[120px] -z-10 animate-pulse pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-125 h-125 bg-blue-500/5 rounded-full blur-[120px] -z-10 pointer-events-none" />
            ...
            <div className="lg:col-span-8 space-y-8">
              {items.map((item) => (
                <div
                  ...
                  className="group relative glass-card rounded-4xl md:rounded-[3.5rem] p-1.5 md:p-2 hover:shadow-premium-hover transition-all duration-500 hover:-translate-y-1"
                >
                  <div className="bg-white/40 dark:bg-card/40 rounded-[1.75rem] md:rounded-[3rem] border border-white/10 p-4 md:p-6 flex flex-col sm:flex-row items-center gap-6 md:gap-8">
                    <div className="relative h-28 w-28 shrink-0 overflow-hidden rounded-4xl bg-secondary/30 shadow-inner group">
                      <Image
                        src={
                    ...
                    <div className="flex-1 text-center sm:text-left space-y-2">
                      ...
                      <p className="text-[10px] font-bold tracking-tight text-muted-foreground opacity-40">
                        Prix unitaire: {formatCurrency(item.product.price)}
                      </p>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between items-end border-b border-border/50 pb-4">
                      <div className="space-y-1">
                        <span className="text-[10px] font-bold tracking-tight text-muted-foreground opacity-60">
                          Sous-total
                        </span>
                        <p className="text-xl font-bold tracking-tight leading-none tabular-nums">
                    ...
                    <div className="flex justify-between items-end border-b border-border/50 pb-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm font-bold text-emerald-600 tracking-tight leading-none">
