    ...
    <PublicLayout>
      <div className="relative min-h-screen pb-32 overflow-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <div className="container mx-auto px-6 pt-20 lg:pt-32 space-y-40 relative z-10">
          ...
          <section className="grid gap-20 lg:grid-cols-12 items-center">
            <div className="lg:col-span-7 space-y-10 animate-in fade-in slide-in-from-left-12 duration-1000">
              ...
              <h1 className="text-7xl md:text-9xl font-black tracking-tighter leading-[0.85] text-slate-900 dark:text-white">
                La quincaillerie <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-primary via-blue-400 to-primary bg-size-[200%_auto] animate-gradient">
                  La Championne.
                </span>
              </h1>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <Link href="/products" className="shrink-0 w-full md:w-auto">
                  <Button
                    size="lg"
                    className="bg-primary text-white hover:bg-primary/90 rounded-3xl px-12 h-18 font-black tracking-tighter text-xl shadow-2xl shadow-primary/20 transition-all hover:-translate-y-1"
                  >
                    Voir le catalogue
                  </Button>
                </Link>
                <Link href="/contact" className="shrink-0 w-full md:w-auto">
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-3xl px-12 h-18 border-2 border-slate-200 dark:border-white/10 font-bold tracking-tight text-lg hover:bg-white dark:hover:bg-white/5 hover:-translate-y-1 transition-all backdrop-blur-md"
                  >
                    Demander conseil
                  </Button>
                </Link>
            ...
            <div className="lg:col-span-5 relative animate-in fade-in zoom-in-95 duration-1000 delay-300">
              <div className="relative group p-2 rounded-[5rem] bg-linear-to-br from-white/30 to-transparent dark:from-white/10 border border-white/20 dark:border-white/5 shadow-3xl overflow-hidden aspect-4/5 lg:aspect-square">
                <Image
                ...
                <div className="absolute bottom-16 left-16 right-16 text-white space-y-4 translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                  ...
                  <p className="text-[10px] font-black tracking-[0.4em] text-blue-400">
          ...
          <section className="relative p-2 rounded-[5rem] bg-white/20 dark:bg-white/5 backdrop-blur-3xl border border-white/40 dark:border-white/10 shadow-3xl animate-in fade-in duration-1000">
            <div className="grid grid-cols-2 gap-12 md:grid-cols-4 p-12 md:p-20">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="text-center group border-r border-slate-200 dark:border-white/10 last:border-none px-6"
                >
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              {values.map((value, i) => (
                ...
                >
                  <div
                    className={cn(
                      "inline-flex h-16 w-16 items-center justify-center rounded-3xl mb-10 text-white shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500",
                      value.color,
                    )}
                  >
                    <value.icon className="h-8 w-8" />
                  </div>
                  <h3 className="text-2xl font-black tracking-tighter mb-5 group-hover:text-primary transition-colors leading-none">
                    {value.title}
                  </h3>
          ...
          <section className="relative rounded-[6rem] p-2 bg-linear-to-br from-indigo-950 to-slate-950 shadow-4xl group overflow-hidden">
            ...
            <div className="relative z-10 p-12 lg:p-24 flex flex-col lg:flex-row items-center gap-24">
              ...
              <div className="relative h-150px w-full lg:w-1/2 overflow-hidden rounded-[5rem] border border-white/10 shadow-3xl bg-slate-900 group/image">
                <Image
