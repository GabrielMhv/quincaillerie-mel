...
export function OrdersTable({ orders, isGlobalScope, currentUserId, userRole }: OrdersTableProps) {
                  ...
                  <div className="flex flex-col">
                    ...
                    {order.referred_employee_name && (
                      <span className="text-[10px] font-bold text-primary italic flex items-center gap-1">
                         <User className="h-2.5 w-2.5" /> {order.referred_employee_name}
                      </span>
                    )}
                  </div>
                </td>
                ...
                <td className="px-8 text-right">
                  <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    {order.latitude && order.longitude && (
                      ...
                      >
                        <Button variant="ghost" size="icon" className="h-10 w-10 rounded-2xl hover:bg-emerald-100 hover:text-emerald-600 transition-all">
              ...
              <tr className="h-64">
                <td colSpan={isGlobalScope ? 7 : 6} className="text-center">
                  <div className="flex flex-col items-center justify-center space-y-4 opacity-30">
                     ...
                     <p className="text-sm font-black tracking-tight">Aucune commande enregistrée</p>
                  </div>
                </td>
              </tr>
            )}
